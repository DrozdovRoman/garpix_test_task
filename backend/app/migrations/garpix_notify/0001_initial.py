    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_delete_after', models.BooleanField(default=False, verbose_name='Удалять после отправки')),
                ('text', models.TextField(verbose_name='Текст')),
                ('html_from_type', models.TextField(choices=[('ckeditor', 'Визуальный редактор'), ('zipfile', 'Загрузка из архива')], default='ckeditor', max_length=8, verbose_name='Способ формирования html')),
                ('html', ckeditor_uploader.fields.RichTextUploadingField(blank=True, verbose_name='HTML')),
                ('zipfile', models.FileField(blank=True, help_text='Поддерживаются архивы в форматах ZIP и RAR с единственным HTML-файлом и ассетами изображений по относительному или абсолютному пути', null=True, upload_to=garpix_notify.utils.file.get_file_path, validators=[garpix_notify.utils.validators.validate_zip], verbose_name='Файл архива')),
